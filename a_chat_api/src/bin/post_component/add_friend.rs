...
// SQL実行部分
pub async fn add_friend(pool: &MySqlPool, user_id:&str, friend_user_id: &str) -> anyhow::Result<AddFriendResult> {
...
pub async fn add_friend_result(pool: &MySqlPool,friend_user_id: &str, direct_chat_room_id: &str) -> anyhow::Result<AddFriendResult> {
